...
SELECT 
      ...
      ,final_mkt_gmv_total_last_2week
			...
			,actual_unit_LW_vs_fc
			,actual_mkt_gmv_LW_vs_fc
...
select a1.sku
      ...
      ,final_mkt_gmv_total_last_2week
			...
			,((final_mkt_gmv_total_last_week- fc_mkt_gmv_total_last_week)/fc_mkt_gmv_total_last_week) as actual_mkt_gmv_LW_vs_fc
...
on a.sku=b.sku 
WHERE a.Company= "Y4A"  and a.root_category = "Sporting Goods" and b.country="USA") a1 
left join
(
...
(
select e.sku,platform, final_unit_1stmonth_LW,discount_spend_1stmonth_LW,ppc_spend_1stmonth_LW, mkt_fee_total_1stmonth_LW,final_gmv_1stmonth_LW,final_mkt_gmv_total_1stmonth_LW
from 
(
...
GROUP BY sku, platform
 ...
 left join 
 (
select e.sku,platform, final_unit_last_2week,discount_spend_last_2week,ppc_spend_last_2week, mkt_fee_total_last_2week,final_gmv_last_2week,final_mkt_gmv_total_last_2week
from 
(
...
WHERE a.`First day of week` <=CURRENT_DATE()-7 and month (a.`First day of week`) = month(CURRENT_DATE()-7) and year(a.`First day of week`) = year(CURRENT_DATE()-7) ) b
